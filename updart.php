...
if ($_SERVER["REQUEST_METHOD"] == "POST")  {
	...
	$NumArt = ($_POST["id"]);
	$query = $bdPdo->prepare('UPDATE article SET DtCreA = :DtCreA, LibTitrA = :LibTitrA, LibChapoA = :LibChapoA, LibAccrochA = :LibAccrochA, Parag1A = :Parag1A, LibSsTitr1 = :LibSsTitr1, Parag2A = :Parag2A, LibSsTitr2 = :LibSsTitr2, Parag3A = :Parag3A, LibConclA = :LibConclA, UrlPhotA = :UrlPhotA, Likes = :Likes, NumLang = :NumLang, NumThem = :NumThem, NumAngl = :NumAngl WHERE NumArt = :NumArt');
	$query->execute(
		array(
			':DtCreA' => $DtCreA,
			':LibTitrA' => $LibTitrA,
...
<div class="article-header">
	...
	<form method="POST" action="UpdArt.php">
		...
		Date :<input type="text" name="DtCreA" id="DtCreA" size="25" maxlength="25" value="<?= $DtCreA?>"><br>
		Titre :<input type="text" name="LibTitrA" id="LibTitrA" size="40" maxlength="40" value="<?= $LibTitrA?>"><br>
		Chapo :<input type="text" name="LibChapoA" id="LibChapoA" size="25" maxlength="25" value="<?= $LibChapoA?>"><br>
		Accroche :<input type="text" name="LibAccrochA" id="LibAccrochA" size="40" maxlength="40" value="<?= $LibAccrochA?>"><br>
		Paragraphe 1 :<input type="text" name="Parag1A" id="Parag1A" size="40" maxlength="40" value="<?= $Parag1A?>"><br>
		Sous-titre 1 :<input type="text" name="LibSsTitr1" id="LibSsTitr1" size="25" maxlength="25" value="<?= $LibSsTitr1?>"><br>
		Paragraphe 2 :<input type="text" name="Parag2A" id="Parag2A" size="40" maxlength="40" value="<?= $Parag2A?>"><br>
		Sous-titre 2 :<input type="text" name="LibSsTitr2" id="LibSsTitr2" size="25" maxlength="25" value="<?= $LibSsTitr2?>"><br>
		Paragraphe 3 :<input type="text" name="Parag3A" id="Parag3A" size="40" maxlength="40" value="<?= $Parag3A?>"><br>
		Conclusion :<input type="text" name="LibConclA" id="LibConclA" size="25" maxlength="25" value="<?= $LibConclA?>"><br>
		URL Photo :<input type="text" name="UrlPhotA" id="UrlPhotA" size="40" maxlength="40" value="<?= $UrlPhotA?>"><br>
		Likes <input type="text" name="Likes" id="Likes" size="25" maxlength="25" value="<?= $Likes?>"><br>
		<br><br>
