    ...
    else
    {
        ...
        else
        {
            ...
            <form method="POST" action="">
                ...
                Date : <input type="date" name="DtCreA" id="DtCreA" placeholder="Date"><br>
                <input type="text" name="LibTitrA" id="LibTitrA"  placeholder="Titre">
                <input type="text" name="LibChapoA" id="LibChapoA"placeholder="Chapo">
                <input type="text" name="LibAccrochA" id="LibAccrochA" placeholder="Accroche"><br>
                <input type="text" name="Parag1A" id="Parag1A" placeholder="Paragraphe 1">
                <input type="text" name="LibSsTitr1" id="LibSsTitr1" placeholder="Sous-tire 1"><br>
                <input type="text" name="Parag2A" id="Parag2A" placeholder="Paragraphe 2">
                <input type="text" name="LibSsTitr2" id="LibSsTitr2" placeholder="Sous-titre 2"><br>
                <input type="text" name="Parag3A" id="Parag3A" placeholder="Paragraphe 3">
                <input type="text" name="LibConclA" id="LibConclA" placeholder="Conlusion"><br>
                <input type="url" name="UrlPhotA" id="UrlPhotA" placeholder="URL Photo">
